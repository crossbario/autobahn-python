...
class SelectNewProfile(Gtk.Window):
    """
    ...
    def __init__(self, config_path, profile_name, selected):
        ...
        label0.set_alignment(0.5, 0)
        grid1.attach(label0, 0, 0, 2, 1)

        label1 = Gtk.Label(label='Create a new account')
        label1.set_alignment(0, 0.5)
        label1.set_justify(Gtk.Justification.LEFT)
        grid1.attach(label1, 1, 1, 1, 1)
        ...
        grid1.attach(button3, 0, 3, 1, 1)

        notebook1.append_page(grid1)
