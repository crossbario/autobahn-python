...
def test_registered_deserialize_from_bytes(serializer_id, registered_samples, create_serializer):
    """
...
def test_registered_serialize_to_bytes(serializer_id, registered_samples, create_serializer):
    """
