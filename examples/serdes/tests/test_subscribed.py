...
def test_subscribed_deserialize_from_bytes(serializer_id, subscribed_samples, create_serializer):
    """
...
def test_subscribed_serialize_to_bytes(serializer_id, subscribed_samples, create_serializer):
    """
